...
c
      ...
      real pi
      parameter (pi=3.141592653589793)
C     MVO::turn m into integer
c$$$      real xmu0,xm,xr,mu,Gu,xIm(21),m,dL
...
C     MVO::added type declarations
      ...
      common/feuille/tl,rl,lai
C     MVO::revised order (alignment-issue after n_c has type integer)
c$$$      common/canopee/df,x_nf,a_f,n_c,h_c,x_ly,r 
...
C
C     MVO/TXK fixed:xIf(m+1,?) will be accessed later and *must*
...
c
      ...
      enddo
      enddo
c$$$      print*, 'MVMV::debug:l=',l,'nt=',nt,'m=',m,
c$$$     &     '(m+1)*number=',(m+1)*number
c$$$      print*, 'MVMV::goon=',((l.lt.1000).and.(nt.ne.(m+1)*number))
...
C     MVO::MM switched type real->integer
c$$$      real phi_w,teta_w,x,y,x_lambda(32,32),MM(32,32)
